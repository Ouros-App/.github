...
![Projeto](https://img.shields.io/badge/projeto-interdisciplinar%202026-111111?style=for-the-badge)
![B2B](https://img.shields.io/badge/modelo-B2B-111111?style=for-the-badge)
![Offline First](https://img.shields.io/badge/app-offline--first-111111?style=for-the-badge)
...
```mermaid
flowchart LR
    A[🏡 Produtor] --> B[📱 Aplicativo Ouros]
    B --> C[💧 Água]
    B --> D[⚡ Energia]
    C --> E[🧠 Motor de análise]
    D --> E
    E --> F[📊 Indicadores]
    E --> G[🏆 Ranking]
    E --> H[🔔 Alertas]
